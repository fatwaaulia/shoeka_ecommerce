                ...
                <div class="card-body">
                    <form id="form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" inputmode="numeric" class="form-control" id="potongan" name="potongan" value="<?= dotsNumber(abs($data['potongan'])) ?>" placeholder="Masukkan potongan" oninput="this.value = dotsNumber(this.value)">
                            <div class="invalid-feedback" id="invalid_potongan"></div>
                        </div>
                        <div class="mb-3">
                            <label for="minimal_ongkir" class="form-label">Minimal Ongkir</label>
                            <input type="text" inputmode="numeric" class="form-control" id="minimal_ongkir" name="minimal_ongkir" value="<?= dotsNumber(abs($data['minimal_ongkir'])) ?>" placeholder="Masukkan minimal ongkir" oninput="this.value = dotsNumber(this.value)">
